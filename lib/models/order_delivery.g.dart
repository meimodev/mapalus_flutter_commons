...
_OrderDelivery _$OrderDeliveryFromJson(Map<String, dynamic> json) =>
    _OrderDelivery(
      ...
      selectedTime: DeliveryTime.fromJson(
        json['selected_time'] as Map<String, dynamic>,
      ),
      selectedDate: const TimestampToDateTimeConverter().fromJson(
        json['selected_date'],
      ),
      lastUpdate: const TimestampToDateTimeConverter().fromJson(
        json['last_update'],
      ),
...
Map<String, dynamic> _$OrderDeliveryToJson(_OrderDelivery instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'selected_date': const TimestampToDateTimeConverter().toJson(
        instance.selectedDate,
      ),
      'last_update': const TimestampToDateTimeConverter().toJson(
        instance.lastUpdate,
      ),
